...
export default function Journal() {
    ...
    return (
        <div className="min-h-screen p-4 md:p-8" style={{ background: P.bg, color: P.text }}>
            ...
            <div className="flex items-start justify-between mb-8">
                ...
                <button onClick={handleNewPage} title="Trang mới — xoá và bắt đầu lại"
                    ...
                    <div className="relative rounded-2xl overflow-hidden"
                        ...
                        <div className="relative p-6 pl-9">
                            ...
                            <textarea
                                ...
                                className="w-full h-[300px] md:h-[360px] resize-none bg-transparent outline-none leading-8 text-[15px]"
                                style={{
                                    color: P.text,
                                    fontFamily: "'Georgia', serif",
                                    caretColor: P.accent,
                                    // placeholder color via CSS custom property trick
                                }}
                            />
                ...
                <div className="space-y-4">
                    ...
                    <div className={`rounded-2xl p-5 border transition-all duration-500
                        ...
                        {result
                            ...
                            : <p className="text-sm" style={{ color: P.muted }}>Chưa có kết quả</p>
                        }
                    </div>
                            ...
                            return (
                                <div className="rounded-2xl overflow-hidden shadow-2xl"
                                    ...
                                    <div className="h-1.5 w-full"
                                        style={{ background: P.spine, opacity: 0.8 }} />
